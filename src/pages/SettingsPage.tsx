          ...
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/90 backdrop-blur-md">
            ...
            >
              ...
              <p className="text-white/60 mb-8 text-center leading-relaxed">
                Esta acción es <span className="text-red-500 font-bold">irreversible</span>. Se borrarán todas tus publicaciones, mensajes, seguidores y toda tu actividad en <span className="text-primary-400 font-bold italic">Santo Pecado</span>.
              </p>
